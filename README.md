...
<a id="apiReference"></a>
## API Reference
You can refer to the API reference [here](https://developers.docusign.com/docs/click-api/reference/).
...
<a id="changeLog"></a>
## Changelog
You can refer to the complete changelog [here](https://github.com/docusign/docusign-click-csharp-client/blob/master/CHANGELOG.md).
...
<a id="license"></a>
## License
The Docusign Click C# Client SDK is licensed under the [MIT License](https://github.com/docusign/docusign-click-csharp-client/blob/master/LICENSE).
