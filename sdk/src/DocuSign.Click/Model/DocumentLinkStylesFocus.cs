...
namespace DocuSign.Click.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentLinkStylesFocus :  IEquatable<DocumentLinkStylesFocus>, IValidatableObject
    {
        public DocumentLinkStylesFocus()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentLinkStylesFocus" /> class.
        /// </summary>
        ...
        public DocumentLinkStylesFocus(string Border = default(string), string Color = default(string), string FontFamily = default(string), string FontSize = default(string), string FontStyle = default(string), Object FontWeight = default(Object), string Margin = default(string), string Padding = default(string), string TextDecoration = default(string))
        {
            this.Border = Border;
            this.Color = Color;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DocumentLinkStylesFocus);
        }

        /// <summary>
        /// Returns true if DocumentLinkStylesFocus instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentLinkStylesFocus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentLinkStylesFocus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
