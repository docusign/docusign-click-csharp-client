...
namespace DocuSign.Click.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgreeButtonStyles :  IEquatable<AgreeButtonStyles>, IValidatableObject
    {
        public AgreeButtonStyles()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="AgreeButtonStyles" /> class.
        /// </summary>
        /// <param name="Disabled">Control the element&#39;s style when element is disabled.</param>
        /// <param name="Focus">Control the elements&#39;s style when element is focused.</param>
        /// <param name="Hover">control the element&#39;s hover style when hovered.</param>
        ...
        public AgreeButtonStyles(BaseAgreeButtonStyles Disabled = default(BaseAgreeButtonStyles), BaseAgreeButtonStyles Focus = default(BaseAgreeButtonStyles), BaseAgreeButtonStyles Hover = default(BaseAgreeButtonStyles), string BackgroundColor = default(string), string Border = default(string), string BorderColor = default(string), string BorderRadius = default(string), string BorderStyle = default(string), string BorderWidth = default(string), string BoxShadow = default(string), string Color = default(string), string FontFamily = default(string), string FontSize = default(string), string FontStyle = default(string), Object FontWeight = default(Object), string Height = default(string), string Margin = default(string), string Opacity = default(string), string Outline = default(string), string OutlineOffset = default(string), string Padding = default(string), string Width = default(string))
        {
        ...
        /// </summary>
        /// <value>Control the element&#39;s style when element is disabled</value>
        [DataMember(Name=":disabled", EmitDefaultValue=false)]
        public BaseAgreeButtonStyles Disabled { get; set; }
        /// <summary>
        /// Control the elements&#39;s style when element is focused
        /// </summary>
        /// <value>Control the elements&#39;s style when element is focused</value>
        [DataMember(Name=":focus", EmitDefaultValue=false)]
        public BaseAgreeButtonStyles Focus { get; set; }
        /// <summary>
        /// control the element&#39;s hover style when hovered
        /// </summary>
        /// <value>control the element&#39;s hover style when hovered</value>
        [DataMember(Name=":hover", EmitDefaultValue=false)]
        public BaseAgreeButtonStyles Hover { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgreeButtonStyles);
        }

        /// <summary>
        /// Returns true if AgreeButtonStyles instances are equal
        /// </summary>
        /// <param name="other">Instance of AgreeButtonStyles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgreeButtonStyles other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
