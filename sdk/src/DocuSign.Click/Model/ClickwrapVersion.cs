...
namespace DocuSign.Click.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClickwrapVersion :  IEquatable<ClickwrapVersion>, IValidatableObject
    {
        public ClickwrapVersion()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ClickwrapVersion" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ClickwrapVersion);
        }

        /// <summary>
        /// Returns true if ClickwrapVersion instances are equal
        /// </summary>
        /// <param name="other">Instance of ClickwrapVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClickwrapVersion other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
